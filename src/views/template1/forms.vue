...
<div class="min-h-screen bg-gray-100 p-0 sm:p-12">
  <div class="mx-auto max-w-md px-6 py-12 bg-white border-0 shadow-lg sm:rounded-3xl">
    <h1 class="text-2xl font-bold mb-8">Ring Form</h1>
    <form id="form" novalidate>
      ...
      <button
        id="button"
        type="button"
        class="w-full px-6 py-3 mt-3 text-lg text-black transition-all duration-150 ease-linear rounded-lg shadow outline-none bg-blue-200 hover:bg-blue-600 hover:shadow-lg focus:outline-none"
      >
        Toggle Error
      </button>
    </form>
